...
public class TurnRight extends CommandBase {
	...
	public TurnRight(double driveTime, double speed) {
	...
	protected void execute() {
		...
		driveTrain.tankDrive(-speed, speed); //make the robot turn right at a speed equal to the value entered
	}
	...
	protected boolean isFinished() {
		if ((passedTime / 1000000) > driveTime) {
			System.out.println("TurnRight is done");
			return true;
		} else
			return false;
	}
